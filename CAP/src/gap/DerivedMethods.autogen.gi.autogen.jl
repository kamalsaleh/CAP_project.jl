...
AddDerivationToCAP( IsEqualAsFactorobjects,
  ...
  function ( cat_1, arg2_1, arg3_1 )
    return IsCodominating( cat_1, arg2_1, arg3_1 ) && IsCodominating( cat_1, arg3_1, arg2_1 );
end; CategoryFilter = IsCapCategory,
      Weight = 1,
      is_autogenerated_by_CompilerForCAP = true );
...
AddDerivationToCAP( IsIsomorphism,
  ...
  function ( cat_1, arg2_1 )
    return IsSplitEpimorphism( cat_1, arg2_1 ) && IsMonomorphism( cat_1, arg2_1 );
end; CategoryFilter = IsCapCategory,
      Weight = 1,
      is_autogenerated_by_CompilerForCAP = true );
...
AddDerivationToCAP( IsomorphismFromCokernelOfKernelToCoimage,
  ...
  function ( cat_1, alpha_1 )
    ...
    return UniversalMorphismIntoCoimage( cat_1, alpha_1, @NTupleGAP( 2, deduped_1_1, ColiftAlongEpimorphism( cat_1, deduped_1_1, alpha_1 ) ) );
end; CategoryFilter = IsAbelianCategory,
      Weight = 1,
      is_autogenerated_by_CompilerForCAP = true );

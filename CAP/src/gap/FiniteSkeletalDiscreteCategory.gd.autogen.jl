...
#! @Arguments C
@DeclareFilter( "IsFiniteSkeletalDiscreteCategory", IsCapCategory );

#! @Description
#!  The &GAP; type of an object in a finite skeletal discrete category.
#! @Arguments O
@DeclareFilter( "IsObjectInFiniteSkeletalDiscreteCategory", IsCapCategoryObject );

#! @Description
#!  The &GAP; type of a morphism in a finite skeletal discrete category.
#! @Arguments M
@DeclareFilter( "IsMorphismInFiniteSkeletalDiscreteCategory", IsCapCategoryMorphism );

...
#! <Enum>
#! <Item>
#!     SetGAP the options `category_filter`, `category_object_filter`, and `category_morphism_filter`
...
#! </Item>
#! <Item>
#!     SetGAP `object_constructor`, `object_datum`, `morphism_constructor`, and `morphism_datum`
...
#! </Item>
#! <Item>
#!    SetGAP `modeling_tower_object_constructor`, `modeling_tower_object_datum`,

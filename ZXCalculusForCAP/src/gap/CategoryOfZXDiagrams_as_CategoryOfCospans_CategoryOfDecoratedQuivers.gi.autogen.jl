    ...
    modeling_tower_object_constructor =
      function ( cat, integer )
        ...
        decorated_quiver = ObjectConstructor( decorated_quivers, PairGAP(
            ...
            PairGAP( ListWithIdenticalEntries( integer, BigInt( 0 ) ), CapJitTypedExpression( [ ], ( ) -> CapJitDataTypeOfListOf( IsBigInt ) ) ) ) );
      ...
      local csp, decorated_quivers, pair, integer;
        ...
        @Assert(
            ...
            pair == PairGAP(
                ...
                # (decorations_of_vertices, deocorations_of_edges)
                PairGAP( ListWithIdenticalEntries( integer, BigInt( 0 ) ), [ ] )
            )
        );

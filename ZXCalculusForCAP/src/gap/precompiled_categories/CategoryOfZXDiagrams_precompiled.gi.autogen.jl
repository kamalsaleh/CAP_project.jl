...
function ( cat_1, a_1, s_1 )
    ...
    deduped_2_1 = AsInteger( a_1 );
    deduped_1_1 = (0):(deduped_2_1 - 1);
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, a_1, VertexLabeledGraph, @NTupleGAP( 4, ListWithIdenticalEntries( deduped_2_1, "neutral" ), deduped_1_1, deduped_1_1, CapJitTypedExpression( [  ], function (  )
                return @rec(
                    filter = IsList,
                    element_type = @rec(
                        filter = IsNTuple,
...
function ( cat_1, alpha_1, beta_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_33_1, deduped_34_1, VertexLabeledGraph, @NTupleGAP( 4, List( (0):(BigInt( Length( deduped_19_1 ) ) - 1), function ( y_2 )
                ...
                local deduped_1_2;
                deduped_1_2 = 1 + x_2[1];
                return @NTupleGAP( 2, hoisted_14_1[deduped_1_2], hoisted_16_1[deduped_1_2] );
            end ) ) );
end
########
...
function ( cat_1, alpha_1, beta_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, deduped_35_1, deduped_36_1, VertexLabeledGraph, @NTupleGAP( 4, List( (0):(BigInt( Length( deduped_19_1 ) ) - 1), function ( y_2 )
                if (@not y_2 in deduped_5_1)
                    return "neutral";
                else
                    return hoisted_6_1[SafePosition( deduped_5_1, y_2 )];
                ...
                local deduped_1_2;
                deduped_1_2 = 1 + x_2[1];
                return @NTupleGAP( 2, hoisted_16_1[deduped_1_2], hoisted_18_1[deduped_1_2] );
            end ) ) );
end
########
...
function ( cat_1, a_1, s_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, a_1, VertexLabeledGraph, @NTupleGAP( 4, ListWithIdenticalEntries( deduped_1_1, "neutral" ), (0):(deduped_1_1 - 1), (0):(AsInteger( s_1 ) - 1), CapJitTypedExpression( [  ], function (  )
                return @rec(
                    filter = IsList,
                    element_type = @rec(
                        filter = IsNTuple,
...
function ( cat_1, s_1, alpha_1, beta_1, r_1 )
    ...
    return CreateCapCategoryMorphismWithAttributes( cat_1, s_1, r_1, VertexLabeledGraph, @NTupleGAP( 4, @Concatenation( deduped_12_1, deduped_16_1[1] ), @Concatenation( List( (0):(AsInteger( Source( alpha_1 ) ) - 1), function ( i_2 )
                  return hoisted_1_1[1 + i_2];
              end ), List( (0):(AsInteger( Source( beta_1 ) ) - 1), function ( i_2 )
                  return deduped_3_1 + hoisted_2_1[1 + i_2];
              end ) ), @Concatenation( List( (0):(AsInteger( Range( alpha_1 ) ) - 1), function ( i_2 )

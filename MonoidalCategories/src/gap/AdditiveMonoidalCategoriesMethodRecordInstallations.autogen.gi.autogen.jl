...
@InstallMethod( AddLeftDistributivityExpanding,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "LeftDistributivityExpanding", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddLeftDistributivityExpandingUsingMultiplicities,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "LeftDistributivityExpandingUsingMultiplicities", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddLeftDistributivityExpandingUsingMultiplicitiesWithGivenObjects,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "LeftDistributivityExpandingUsingMultiplicitiesWithGivenObjects", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddLeftDistributivityExpandingWithGivenObjects,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "LeftDistributivityExpandingWithGivenObjects", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddLeftDistributivityFactoring,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "LeftDistributivityFactoring", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddLeftDistributivityFactoringUsingMultiplicities,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "LeftDistributivityFactoringUsingMultiplicities", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddLeftDistributivityFactoringUsingMultiplicitiesWithGivenObjects,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "LeftDistributivityFactoringUsingMultiplicitiesWithGivenObjects", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddLeftDistributivityFactoringWithGivenObjects,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "LeftDistributivityFactoringWithGivenObjects", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddRightDistributivityExpanding,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "RightDistributivityExpanding", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddRightDistributivityExpandingUsingMultiplicities,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "RightDistributivityExpandingUsingMultiplicities", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddRightDistributivityExpandingUsingMultiplicitiesWithGivenObjects,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "RightDistributivityExpandingUsingMultiplicitiesWithGivenObjects", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddRightDistributivityExpandingWithGivenObjects,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "RightDistributivityExpandingWithGivenObjects", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddRightDistributivityFactoring,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "RightDistributivityFactoring", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddRightDistributivityFactoringUsingMultiplicities,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "RightDistributivityFactoringUsingMultiplicities", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddRightDistributivityFactoringUsingMultiplicitiesWithGivenObjects,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "RightDistributivityFactoringUsingMultiplicitiesWithGivenObjects", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );
...
@InstallMethod( AddRightDistributivityFactoringWithGivenObjects,
    ...
    @FunctionWithNamedArguments(
        ...
        function( CAP_NAMED_ARGUMENTS, category, func, weight )
            ...
            AddCapOperation( "RightDistributivityFactoringWithGivenObjects", category, func, weight; IsPrecompiledDerivation = IsPrecompiledDerivation );

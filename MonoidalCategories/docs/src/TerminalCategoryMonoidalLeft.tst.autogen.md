...
```jldoctest
julia> using CAP, MonoidalCategories
...
julia> LeftClosedMonoidalCategoriesTest( T, opposite, a, b, c, d, alpha, beta, gamma, delta, epsilon, zeta );
...
julia> LeftCoclosedMonoidalCategoriesTest( T, opposite, a, b, c, d, alpha, beta, gamma, delta, epsilon, zeta );

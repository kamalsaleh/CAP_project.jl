...
WriteFileForMonoidalStructure(
        @rec(
             ...
             safe_replace = [ ##############################
                               ...
                               [ "TensorProductOnMorphismAndObject( opposite",
                                 "CoproductOnMorphismAndObject( opposite" ],
                               ## TensorProductOnObjectAndMorphism
                               [ "TensorProductOnObjectAndMorphism( opposite",
                                 "CoproductOnObjectAndMorphism( opposite" ],
                               ## Braiding
                               [ "Braiding( opposite",
        ...
        "CartesianCategories",
        @rec( MonoidalCategoriesTensorProductOnObjectsAndTensorUnit_gd = fail,
             MonoidalCategoriesTensorProductOnObjectsAndTensorUnitTest_gd = fail,
             ...
             MonoidalCategoriesTensorProductOnObjectsAndTensorUnitMethodRecord_gi = fail,
             MonoidalCategoriesTensorProductOnObjectsAndTensorUnit_gi = fail,
             MonoidalCategoriesTensorProductOnObjectsAndTensorUnitTest_gi = fail,
...
WriteFileForMonoidalStructure(
        @rec(
             ...
             safe_replace = [ ##############################
                               ...
                               ## TensorProductOnMorphismAndObject
                               [ "TensorProductOnMorphismAndObject( opposite",
                                 "DirectProductOnMorphismAndObject( opposite" ],
                               ## TensorProductOnObjectAndMorphism
                               [ "TensorProductOnObjectAndMorphism( opposite",
                                 "DirectProductOnObjectAndMorphism( opposite" ],
                               ## Braiding
                               [ "Braiding( opposite",

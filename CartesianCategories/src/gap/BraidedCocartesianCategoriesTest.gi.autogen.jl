...
@InstallMethod( TestCocartesianBraidingForInvertibility,
  ...
  function( cat, object_1, object_2 )
    ...
    return IsOne( PreCompose( CocartesianBraiding( object_1, object_2 ), CocartesianBraidingInverse( object_1, object_2 ) ) ) &&
           IsOne( PreCompose( CocartesianBraidingInverse( object_1, object_2 ), CocartesianBraiding( object_1, object_2 ) ) ) &&
           IsOne( PreCompose( CocartesianBraiding( object_2, object_1 ), CocartesianBraidingInverse( object_2, object_1 ) ) ) &&

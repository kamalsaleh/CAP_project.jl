...
[ BraidingInverseWithGivenTensorProducts,
 ...
 ; CategoryFilter = cat -> HasIsCocartesianCategory( cat ) && IsCocartesianCategory( cat ) &&
                      HasIsSymmetricMonoidalCategoryStructureGivenByCoproduct( cat ) && IsSymmetricMonoidalCategoryStructureGivenByCoproduct( cat ) );

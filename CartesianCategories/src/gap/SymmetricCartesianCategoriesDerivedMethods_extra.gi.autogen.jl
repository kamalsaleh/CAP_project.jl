...
[ BraidingInverseWithGivenTensorProducts,
 ...
 ; CategoryFilter = cat -> HasIsCartesianCategory( cat ) && IsCartesianCategory( cat ) &&
                      HasIsSymmetricMonoidalCategoryStructureGivenByDirectProduct( cat ) && IsSymmetricMonoidalCategoryStructureGivenByDirectProduct( cat ) );
